        ...
        <section class="sidebar">
            ...
            <div class="d-flex flex-column align-items-stretch flex-shrink-0 bg-body-tertiary" style="width: 600px;">
                ...
                <div>
                    ...
                    <a href="login.html" class="btn btn-primary me-2">Login/Sign up</a>
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                                ...
                                <form id="filterForm">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio" name="sortPrice" id="sortLowToHigh" value="lowToHigh" checked>
                                            <label class="form-check-label" for="sortLowToHigh">
                                                Lowest to Highest
                                            </label>
                                        </div>
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio" name="sortPrice" id="sortHighToLow" value="highToLow">
                            ...
                            <div class="modal-footer">
                                ...
                                <button type="button" class="btn btn-primary" onclick="applyFilters()">Save changes</button>
...
<!-- PHP CODE HERE -->
                    ...
                    <a href="listing.html" class="list-group-item list-group-item-action py-3 lh-sm">
                        <div class="d-flex w-100 align-items-center justify-content-between">
                            <strong class="mb-1">List group item heading</strong>
